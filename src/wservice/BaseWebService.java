...
public class BaseWebService {
	...
	protected String executeWebService(String service, String method, HashMap<String, String> params) throws MalformedURLException, IOException, WebServiceException {
		String strUrl = BaseWebService.WS_BYJG;
		...
		if (result.contains("ERR|")) {
			throw new WebServiceException(result.substring(4));
		}
